...
function fondo1(){
    document.getElementById("vista").src="./img/barcelona.jpeg";
}

function fondo2(){
    document.getElementById("vista").src="./img/barcelona2.jpg";
}

function fondo3(){
    document.getElementById("vista").src="./img/barcelona3.jpg";
}