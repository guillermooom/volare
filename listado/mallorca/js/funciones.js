...
function fondo1(){
    document.getElementById("vista").src="./img/mallorca1.jpg";
}

function fondo2(){
    document.getElementById("vista").src="./img/mallorca2.jpg";
}

function fondo3(){
    document.getElementById("vista").src="./img/mallorca3.jpg";
}
