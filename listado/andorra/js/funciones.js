...
function fondo1(){
    document.getElementById("vista").src="./img/andorra1.jpg";
}

function fondo2(){
    document.getElementById("vista").src="./img/andorra2.jpg";
}

function fondo3(){
    document.getElementById("vista").src="./img/andorra3.jpg";
}
