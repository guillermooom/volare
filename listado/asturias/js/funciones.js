...
function fondo1(){
    document.getElementById("vista").src="./img/asturias1.jpg";
}

function fondo2(){
    document.getElementById("vista").src="./img/asturias2.jpg";
}

function fondo3(){
    document.getElementById("vista").src="./img/asturias3.jpg";
}
