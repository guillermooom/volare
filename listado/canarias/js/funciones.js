...
function fondo1(){
    document.getElementById("vista").src="./img/canarias.jpeg";
}   

function fondo2(){
    document.getElementById("vista").src="./img/Tenerife.jpg";
}   

function fondo3(){
    document.getElementById("vista").src="./img/tenerife2.jpg";
