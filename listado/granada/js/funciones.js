...
function fondo1(){
    document.getElementById("vista").src="./img/granada1.jpg";
}

function fondo2(){
    document.getElementById("vista").src="./img/granada2.jpg";
}

function fondo3(){
    document.getElementById("vista").src="./img/granada3.jpg";
}
